      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">We optimize every part of the application process to ensure that you can get a job as quick as possible.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Search Strategy</h4>
              <p className="text-gray-600 text-center">Determine current stregths and areas of opportunity to develop application approach.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Network Development</h4>
              <p className="text-gray-600 text-center">Identify and leverage connections to maximize prospecting efforts.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Interview Practice</h4>
              <p className="text-gray-600 text-center">Learn and rehearse effective interview strategies.</p>
            </div>
            {/* 4th item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Application Submissions</h4>
              <p className="text-gray-600 text-center">Submit effective applications to maximize interviews and offers.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Resume Review</h4>
              <p className="text-gray-600 text-center">Optimize your resume to increase your response rate.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Salary Negotiation</h4>
              <p className="text-gray-600 text-center">Learn to use leverage and negotiation techniques to maximize your salary.</p>
            </div>
